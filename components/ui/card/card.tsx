 ...
 * Uses the mandatory color palette for background and borders
 */
...
/**
 * Card title with appropriate typography
 */
...
/**
 * Card content section with padding (no top padding for connection with header)
 */
